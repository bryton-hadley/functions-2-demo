...
//create new function and call back the function while using an arrow function 
// while doing this we will make three properies and invoke the callback 
// then we will console log calculator
...
// console.log(calculator(14, 7, subtract))
...
// CODE HERE
//writing some functions to the array
// will use dot notation to subtract  the discout from the product

const applyFlatRateDiscount = (product, discount) => {
    product.displayPrice = product.basePrice - discount
}

const applyPrecentaggeDiscount = (product, discount) => {
...
applyDiscount(dogProducts, applyPrecentaggeDiscount, 0.1)
...
// CODE HERE
//creating higher oder functions exapmle as well as strings 
//using arrow function 
// we will also return a new arrow function
// use an if statment 
const makeSandwich = (bread) => {
    return (ingredients) => {
        let order = `You odered a ${bread} bread sandwich with `
...
//arrow function to invoke the value of the .map loop 
